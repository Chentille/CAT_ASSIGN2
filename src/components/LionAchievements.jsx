...
// LionAchievements component
function LionAchievements () {
  ...
  useEffect(() => {
    ...
    const clickHandler = function () {
      ...
      containerWrapper.children[1].style.height = '100%';
    ...
    return(
      ...
      <Navbar />
          <section className='section1'>
            ...
            <h1>LION DANCE </h1>
            <h2>"Symbolizing Luck and Prosperity in Vibrant Performances."</h2>
            </div>
          ...
          <section className='section2'>
            ...
            <div className='Middle'>
              ...
              <img src="https://i.ibb.co/ckGsHMT/l3.png" alt="lion-4" />
                <div className='RedContainer'>
                <p class="container-text"> Traditional Lion Dance</p>
                </div>
              </div>
              <div class="blue-container3">
              <img src="https://i.ibb.co/chZGJzB/l1.png" alt="lion-4" />
                <div className='RedContainer'>
                  <p class="container-text"> Lion Dance On High Poles  </p>
                </div>
              </div>
              <div class="blue-container3">
              <img src="https://i.ibb.co/vLTgjyR/l2.png"   alt="lion-4" />
              <div className='RedContainer'>
                  <p class="container-text"> Wedding Lion Dance</p>
                </div>
              </div>
            </div>
          ...
          <div className='Container'>
            ...
            <div className="text-container">
                <ul>
                <li>2016 - China Guang Xi international Lion Dance Championship(3rd Runner Up)</li>
                <li>2017 - Malaysia Haji Abdul Ghani Lion Dance Competition (Silver)</li>
                <li>2018 - Hong Kong World International Lion Dance Tournament (Gold Award)</li>
                <li>2020 - Genting World Lion Dance Championship (2nd Runner Up)</li>
                </ul>
             </div>
            </div>
            <div className='right3'>
            <img src="https://i.ibb.co/cv1pRnM/dragoon-achievement.jpg" />
            </div>
          </div>
          </section>
      </div> 
...
// Exporting the LionAchievements component
export default LionAchievements;